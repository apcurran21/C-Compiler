  ...
  */
  ...
  if (enable_code_generator){
    ...
    */
    ...
    while (p.functions exists){

      p .functions = ...
    }
    Go through elements within our collections function, and invoke a functio nsomewhere else and translate it 
    
    
    */

    for (int f_index = 1; f_index < p.functions.size(); f_index++) {
      int spill_count = -1;
